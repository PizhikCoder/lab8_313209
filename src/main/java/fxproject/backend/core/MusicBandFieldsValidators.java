...
import fxproject.UI.Controllers.MusicBandCreatingFormController;
import javafx.scene.control.ComboBox;
import javafx.scene.control.TextField;

public class MusicBandFieldsValidators {
    public static boolean bandNameValidate(TextField textField, MusicBandCreatingFormController controller) {
    ...
    public static boolean coordinateXValidate(TextField textField, MusicBandCreatingFormController controller){
    ...
    public static boolean coordinateYValidate(TextField textField, MusicBandCreatingFormController controller){
    ...
    public static boolean numberOfParticipantsValidate(TextField textField, MusicBandCreatingFormController controller){
    ...
    public static boolean genreValidate(ComboBox comboBox, MusicBandCreatingFormController controller){
    ...
    public static boolean personHeightValidate(TextField textField, MusicBandCreatingFormController controller){
    ...
    public static boolean personNationalityValidate(ComboBox comboBox, MusicBandCreatingFormController controller){
    ...
    public static boolean locationXValidate(TextField textField, MusicBandCreatingFormController controller){
    ...
    public static boolean locationYValidate(TextField textField, MusicBandCreatingFormController controller){
    ...
    public static boolean locationZValidate(TextField textField, MusicBandCreatingFormController controller){
    ...
    public static boolean personNameValidate(TextField textField, MusicBandCreatingFormController controller){
    ...
    private static boolean personHeightCheck(String height) {
